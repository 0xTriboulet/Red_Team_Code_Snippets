...
use windows_sys::Win32::System::Diagnostics::Debug::{ReadProcessMemory,WriteProcessMemory,IMAGE_NT_HEADERS64,IMAGE_OPTIONAL_HEADER64, IMAGE_SECTION_HEADER};
...
* x> 9. Create malicious thread target process
*
