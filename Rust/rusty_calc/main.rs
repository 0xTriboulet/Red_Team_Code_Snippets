...
//https://www.virustotal.com/gui/file/f1916f1ab6d3f1f338b9d888a40a26993650a34f9eef5f77df57993fc02fbe8a?nocache=1
...
fn main(){
    ...
    if  true {//unsafe {IsDebuggerPresent()} == 0 && !buffer.is_null(){
